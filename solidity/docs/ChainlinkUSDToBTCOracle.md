# ChainlinkUSDToBTCOracle.sol

View Source: [contracts/utility/ChainlinkUSDToBTCOracle.sol](../contracts/utility/ChainlinkUSDToBTCOracle.sol)

**↗ Extends: [IConsumerPriceOracle](IConsumerPriceOracle.md)**

**ChainlinkUSDToBTCOracle**

Provides the USD/BTC rate

## Contract Members
**Constants & Variables**

```js
int256 private constant USD_RATE;
...
always returns the rate of 10000
