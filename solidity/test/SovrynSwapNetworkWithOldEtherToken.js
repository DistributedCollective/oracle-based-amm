...
contract("SovrynSwapNetworkWithOldEtherToken", (accounts) => {
	...
	it("should revert when attempting to convert and the return amount is lower than the given minimum", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert(smartToken2BuyPath, value, 1000000, { from: sender2, value }), "ERR_RETURN_TOO_LOW");
	});

	it("should revert when attempting to convert and passing an amount higher than the ETH amount sent with the request", async () => {
		await expectRevert(
			sovrynSwapNetwork.convert(smartToken2BuyPath, value, MIN_RETURN, { from: sender2, value: value.mul(new BN(2)) }),
	...
	it("should revert when attempting to sell directly for ether and the return amount is lower than the given minimum", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert(smartToken2SellPath, value, value.add(new BN(10000))), "ERR_RETURN_TOO_LOW");
	});
	...
	it("should revert when non owner attempting register ether token", async () => {
		...
		await etherToken1.deposit({ value: 10000000 });
		const sovrynSwapNetwork1 = await SovrynSwapNetwork.new(contractRegistry.address);
		await expectRevert(sovrynSwapNetwork1.registerEtherToken(etherToken1.address, true, { from: nonOwner }), "ERR_ACCESS_DENIED");
	});
	...
	it("should revert when non owner attempting to unregister ether token", async () => {
		...
		await expectRevert(sovrynSwapNetwork1.registerEtherToken(etherToken1.address, false, { from: nonOwner }), "ERR_ACCESS_DENIED");
	});
	...
	it("should revert when calling convertFor with ether amount different than the amount sent", async () => {
		await expectRevert(
			sovrynSwapNetwork.convertFor.call(smartToken1BuyPath, value.add(new BN(1)), MIN_RETURN, sender2, { value }),
			"ERR_ETH_AMOUNT_MISMATCH"
		);
	});
	...
	it("should revert when calling convertFor with invalid long path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convertFor(longBuyPath, value, MIN_RETURN, sender2, { value }), "ERR_INVALID_PATH");
	});
	...
	it("should revert when calling convert with ether amount different than the amount sent", async () => {
		await expectRevert(
			sovrynSwapNetwork.convert.call(smartToken1BuyPath, value.add(new BN(1)), MIN_RETURN, { from: sender2, value }),
			"ERR_ETH_AMOUNT_MISMATCH"
		);
	});
	...
	it("should revert when calling convert with invalid path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert(invalidPath, value, MIN_RETURN, { from: sender2, value }), "ERR_INVALID_PATH");
	});
	...
	it("should revert when calling convert with invalid long path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert(longBuyPath, value, MIN_RETURN, { from: sender2, value }), "ERR_INVALID_PATH");
	});
	...
	it("verifies that getReturnByPath returns the correct amount for selling the smart token with a long conversion path", async () => {
		await sovrynSwapNetwork.convert(
			[etherToken.address, smartToken1.address, smartToken1.address, smartToken2.address, smartToken3.address],
			value,
			MIN_RETURN,
			{ from: sender2, value }
		);
	...
	it("should revert when calling convertFor2 with ether amount different than the amount sent", async () => {
		await expectRevert(
			sovrynSwapNetwork.convertFor2.call(smartToken1BuyPath, value.add(new BN(1)), MIN_RETURN, sender2, ZERO_ADDRESS, 0, { value }),
			"ERR_ETH_AMOUNT_MISMATCH"
		);
	});
	...
	it("should revert when calling convertFor2 with invalid path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convertFor2(invalidPath, value, MIN_RETURN, sender2, ZERO_ADDRESS, 0, { value }), "ERR_INVALID_PATH");
	});
	...
	it("should revert when calling convertFor2 with invalid long path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convertFor2(longBuyPath, value, MIN_RETURN, sender2, ZERO_ADDRESS, 0, { value }), "ERR_INVALID_PATH");
	});
	...
	it("should revert when calling convert2 with ether amount different than the amount sent", async () => {
		await expectRevert(
			sovrynSwapNetwork.convert2.call(smartToken1BuyPath, value.add(new BN(1)), MIN_RETURN, ZERO_ADDRESS, 0, { from: sender2, value }),
			"ERR_ETH_AMOUNT_MISMATCH"
		);
	});
	...
	it("should revert when calling convert2 with invalid path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert2(invalidPath, value, MIN_RETURN, ZERO_ADDRESS, 0, { from: sender2, value }), "ERR_INVALID_PATH");
	});
	...
	it("should revert when calling convert2 with invalid long path", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert2(longBuyPath, value, MIN_RETURN, ZERO_ADDRESS, 0, { from: sender2, value }), "ERR_INVALID_PATH");
	});
	...
	it("should revert when attempting to convert2 and the return amount is lower than the given minimum", async () => {
		await expectRevert(
			sovrynSwapNetwork.convert2(smartToken2BuyPath, value, 1000000, ZERO_ADDRESS, 0, { from: sender2, value }),
			"ERR_RETURN_TOO_LOW"
		);
	});
	...
	it("should revert when attempting to convert2 and passing an amount higher than the ETH amount sent with the request", async () => {
		await expectRevert(
			sovrynSwapNetwork.convert2(smartToken2BuyPath, value, MIN_RETURN, ZERO_ADDRESS, 0, { from: sender2, value: value.add(new BN(1)) }),
			"ERR_ETH_AMOUNT_MISMATCH"
		);
	});
	...
	it("should revert when attempting to sell directly for ether and the return amount is lower than the given minimum", async () => {
		...
		await expectRevert(sovrynSwapNetwork.convert2(smartToken2SellPath, value, value.add(new BN(10)), ZERO_ADDRESS, 0), "ERR_RETURN_TOO_LOW");
	});
	...
	it("verifies that getReturnByPath returns the correct amount for cross reserve conversion", async () => {
		await sovrynSwapNetwork.convert2([etherToken.address, smartToken1.address, smartToken1.address], value, MIN_RETURN, ZERO_ADDRESS, 0, {
			from: sender2,
			value,
		});
		await smartToken1.approve(sovrynSwapNetwork.address, value, { from: sender2 });
	...
	it("verifies that getReturnByPath returns the correct amount for selling the smart token with a long conversion path", async () => {
		await sovrynSwapNetwork.convert2(
			[etherToken.address, smartToken1.address, smartToken1.address, smartToken2.address, smartToken3.address],
			value,
			MIN_RETURN,
			ZERO_ADDRESS,
