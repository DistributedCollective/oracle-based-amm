...
contract('SovrynSwapX', accounts => {
    ...
    it('should not be able to release below the min limit', async () => {
        ...
        await expectRevert(sovrynSwapX.reportTx(EOS_BLOCKCHAIN, TRANSACTION_ID, sender, amount, X_TRANSFER_ID,
    ...
    it('should not allow a reporter to report the same transaction twice', async () => {
        ...
        await expectRevert(sovrynSwapX.reportTx(EOS_BLOCKCHAIN, TRANSACTION_ID, sender, TEST_AMOUNT, X_TRANSFER_ID,
    ...
    it('should not allow two reporters to give conflicting transaction details', async () => {
        ...
        await expectRevert(sovrynSwapX.reportTx(EOS_BLOCKCHAIN, TRANSACTION_ID, reporter2, TEST_AMOUNT, X_TRANSFER_ID,
