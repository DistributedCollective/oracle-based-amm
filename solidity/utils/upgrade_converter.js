...
const run = async() => {
    ...
    //IMPORTANT: MAY NOT BE SET IN CONFIG FILE
...
const testUpdatePriceOracle = async () => {
    let converter = deployed(web3, NEW_CONVERTER_CONTRACT, '0xE664fff6FEFb8AD6fB2bFCC1cC6A665d1d97375E');
    
    const oracleWhitelist = await web3Func(deploy, 'oracleWhitelist', 'Whitelist', []);
    await execute(oracleWhitelist.methods.addAddress('0xA087e209aD9a8788a100b9C9CAA360DE037fed6c'));
    await execute(oracleWhitelist.methods.addAddress('0xa6b254F7A148fA18529608B67cB3B13A836Bc2aC'));
    await execute(converter.methods.updatePriceOracle('0xa6b254F7A148fA18529608B67cB3B13A836Bc2aC','0xA087e209aD9a8788a100b9C9CAA360DE037fed6c'));
