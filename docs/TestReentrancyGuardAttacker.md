# TestReentrancyGuardAttacker.sol

View Source: [contracts/helpers/TestReentrancyGuard.sol](../solidity/contracts/helpers/TestReentrancyGuard.sol)
...
```js
contract TestReentrancyGuard public target;
...
- [setReentrancy(bool _reentrancy)](#setreentrancy)
- [setCallProtectedMethod(bool _callProtectedMethod)](#setcallprotectedmethod)
- [run()](#run)
- [callback()](#callback)
