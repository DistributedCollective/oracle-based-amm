# TestTokenHandler.sol

View Source: [contracts/helpers/TestTokenHandler.sol](../solidity/contracts/helpers/TestTokenHandler.sol)

**↗ Extends: [TokenHandler](TokenHandler.md)**

**TestTokenHandler**

## Functions

- [testSafeApprove(IERC20Token _token, address _spender, uint256 _value)](#testsafeapprove)
