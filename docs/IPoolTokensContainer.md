# IPoolTokensContainer.sol

View Source: [contracts/converter/types/liquidity-pool-v2/interfaces/IPoolTokensContainer.sol](../solidity/contracts/converter/types/liquidity-pool-v2/interfaces/IPoolTokensContainer.sol)

**↗ Extends: [IConverterAnchor](IConverterAnchor.md)**
**↘ Derived Contracts: [PoolTokensContainer](PoolTokensContainer.md)**
...
```solidity
function mint(ISmartToken _token, address _to, uint256 _amount) public nonpayable
```
...
```solidity
function burn(ISmartToken _token, address _from, uint256 _amount) public nonpayable
```
