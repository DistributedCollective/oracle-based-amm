# ChainlinkETHToETHOracle.sol

View Source: [contracts/utility/ChainlinkETHToETHOracle.sol](../solidity/contracts/utility/ChainlinkETHToETHOracle.sol)
...
```js
int256 private constant ETH_RATE;
