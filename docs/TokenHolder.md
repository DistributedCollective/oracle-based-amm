...
View Source: [contracts/utility/TokenHolder.sol](../solidity/contracts/utility/TokenHolder.sol)

**↗ Extends: [ITokenHolder](ITokenHolder.md), [TokenHandler](TokenHandler.md), [Owned](Owned.md), [Utils](Utils.md)**
**↘ Derived Contracts: [ConverterBase](ConverterBase.md), [IFeeSharingProxy](IFeeSharingProxy.md), [IInternalSovrynSwapNetwork](IInternalSovrynSwapNetwork.md), [ILegacyConverter](ILegacyConverter.md), [ISwapSettings](ISwapSettings.md), [PoolTokensContainer](PoolTokensContainer.md), [SmartToken](SmartToken.md), [SovrynSwapNetwork](SovrynSwapNetwork.md), [SovrynSwapX](SovrynSwapX.md)**
...
```solidity
function withdrawTokens(IERC20Token _token, address _to, uint256 _amount) public nonpayable ownerOnly validAddress validAddress notThis 
```
