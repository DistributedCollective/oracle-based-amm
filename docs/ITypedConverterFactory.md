# ITypedConverterFactory.sol

View Source: [contracts/converter/interfaces/ITypedConverterFactory.sol](../solidity/contracts/converter/interfaces/ITypedConverterFactory.sol)

**↘ Derived Contracts: [LiquidityPoolV1ConverterFactory](LiquidityPoolV1ConverterFactory.md), [LiquidityPoolV2ConverterFactory](LiquidityPoolV2ConverterFactory.md), [LiquidTokenConverterFactory](LiquidTokenConverterFactory.md)**
...
```solidity
function createConverter(IConverterAnchor _anchor, IContractRegistry _registry, uint32 _maxConversionFee) public nonpayable
