# LiquidityPoolConverter.sol

View Source: [contracts/converter/LiquidityPoolConverter.sol](../solidity/contracts/converter/LiquidityPoolConverter.sol)

**↗ Extends: [ConverterBase](ConverterBase.md)**
**↘ Derived Contracts: [LiquidityPoolV1Converter](LiquidityPoolV1Converter.md), [LiquidityPoolV1ConverterMultiAsset](LiquidityPoolV1ConverterMultiAsset.md), [LiquidityPoolV2Converter](LiquidityPoolV2Converter.md)**
...
initializes a new LiquidityPoolConverter instance
	 *

```js
constructor(IConverterAnchor _anchor, IContractRegistry _registry, uint32 _maxConversionFee) internal
```
