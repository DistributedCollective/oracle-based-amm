...
View Source: [contracts/utility/BProOracle.sol](../solidity/contracts/utility/BProOracle.sol)
...
```solidity
function setMoCStateAddress(address _mocStateAddress) public nonpayable ownerOnly 
```
