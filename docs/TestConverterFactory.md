# TestConverterFactory.sol

View Source: [contracts/helpers/TestConverterFactory.sol](../solidity/contracts/helpers/TestConverterFactory.sol)

**↗ Extends: [ConverterFactory](ConverterFactory.md)**
...
```js
contract IConverter public createdConverter;
contract IConverterAnchor public createdAnchor;
