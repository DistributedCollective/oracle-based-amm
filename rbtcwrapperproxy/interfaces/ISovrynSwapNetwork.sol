...
interface ISovrynSwapNetwork {
    ...
    function convert(IERC20Token[] calldata _path, uint256 _amount, uint256 _minReturn) external payable returns (uint256);
    ...
    function convertFor(IERC20Token[] calldata _path, uint256 _amount, uint256 _minReturn, address _beneficiary) external payable returns (uint256);
    ...
    function claimAndConvert(IERC20Token[] calldata _path, uint256 _amount, uint256 _minReturn) external returns (uint256);
    ...
    function claimAndConvertFor(IERC20Token[] calldata _path, uint256 _amount, uint256 _minReturn, address _beneficiary) external returns (uint256);
