...
interface ILiquidityPoolV2Converter{
    ...
    function activate(IERC20Token _primaryReserveToken, IConsumerPriceOracle _primaryReserveOracle, IConsumerPriceOracle _secondaryReserveOracle) external;
    ...
    function addLiquidity(IERC20Token _reserveToken, uint256 _amount, uint256 _minReturn) external payable returns (uint256);
